...
##ENR_NodeAttribute;
from outputapi import ENR_demand,ENR_head,ENR_pressure,ENR_quality
ENR_NodeAttributes= (ENR_demand
                    ,ENR_head
                    ,ENR_pressure
                    ,ENR_quality)
##ENR_LinkAttribute;
from outputapi import ENR_flow,ENR_velocity,ENR_headloss,ENR_avgQuality
from outputapi import ENR_status,ENR_setting,ENR_rxRate,ENR_frctnFctr
